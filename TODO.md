...
=============================
 ...
 - 添加日记本入口
 - 打开密码
 - 图片大小优化(服务端 png 转换 jpg)
 - 回复点击直接弹出键盘
 - 提高消息刷新率  1
 - 日记本列表,菊花还是没有遮挡住  1
 - 过期日记隐藏回复框    1
 - 个人信息,在 pc 改了之后,app 不刷新,加上刷新罗技 1
 - 未过期日记能看到图片   1
 - 关注列表
 - 查看图片隐藏状态栏
 - 顶栏,低栏背景色
...
------------------
 ...
 - 修改启动弹出登陆的逻辑，改为没有本地 token 直接弹出登录


 - 话题
 - 注册
    - 注册引导
 - 我的日记页面评论删除按钮未知有问题,把高度撑开了,通过绝对定位修复该问题
 - 日记本合并
 - 过期日记日历查看
 ...
 - 凌晨没有日记时,关注页面提示加载失败   未发现问题
 - 日记详情页右上角加三个点,可编辑
 - 空日记本页面
 - 日记删除后,从提醒打开日记,应提示日记不存在

 - 闪退:是点了过期日记里面的回复的人的头像…
 - 大图加载问题,偶尔加载失败
 - listview 后台更新空白的问题
...
反馈 刚发现了一个问题 启动密码反应太慢啦 有些时候都点进去点开了别人回复了 启动密码才反应过来起作用 然后输密码进去 回复就不见了
...
弹出框圆角 6
 ...
 https://github.com/facebook/react-native/issues/3148 HyperText 原理
